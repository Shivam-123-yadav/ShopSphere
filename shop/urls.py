...
urlpatterns = [
    ...
    path("cashfree/payment/<int:order_id>/", views.cashfree_payment, name="cashfree_payment"),
    path("cashfree/checkout/<int:order_id>/", views.cashfree_checkout, name="cashfree_checkout"),
